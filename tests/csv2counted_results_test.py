...
csv2counted_results_main = R.unodes["csv2counted_results_1_0_0"][
    "class"
].import_engine_as_python_function()
input_csv = os.path.join(
    "tests", "data", "csv2counted_results_1_0_0", "csv2counted_results_test.csv"
)
output_csv = os.path.join(
    "tests", "data", "csv2counted_results_1_0_0", "csv2counted_results_test_counted.csv"
)
...
for line_dict in csv_out:
    test_dict["#".join([line_dict["Protein ID"], line_dict["Charge"]])] = {
        "test": line_dict["test"],
