...
uc = ursgal.UController(profile="LTQ XL low res", force=False)

upeptide_mapper_main = uc.unodes["upeptide_mapper_1_0_0"][
    "class"
].import_engine_as_python_function("main")

input_csv = os.path.join("tests", "data", "test_upeptide_mapper.csv")
output_csv = os.path.join("tests", "data", "test_upeptide_mapper_pmap.csv")
