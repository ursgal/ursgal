...
input_csv = os.path.join("tests", "data", "test_merge_duplicate_rows.csv")
# output_csv = os.path.join(
#     'tests',
#     'data',
#     'test_merge_duplicate_rows_merged_duplicates.csv'
# )
expected_csv = os.path.join("tests", "data", "test_merge_duplicate_rows_expected.csv")

psm_counter = ursgal.ucore.count_distinct_psms(
    csv_file_path=input_csv, psm_defining_colnames=psm_defining_colnames
)
