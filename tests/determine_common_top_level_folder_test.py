...
TESTS = [
    {
        ...
        "output": os.path.join(os.path.abspath(os.sep), "Volumes", "_", "_", "_", "1")
        + os.sep,
    },
    {
        "input": {
        ...
        "output": os.path.join(os.path.abspath(os.sep), "Volumes", "_", "_", "_")
        + os.sep,
    },
    {
        "input": {
...
def determine_common_top_level_folder(test_dict):
    out_put = R.determine_common_top_level_folder(**test_dict["input"])
