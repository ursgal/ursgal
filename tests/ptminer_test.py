...
ursgal_input_csv = os.path.join(
    "tests", "data", "ptminer_1_0", "test_ptminer_1_0_ursgal_results.csv"
)

ptminer_input_csv = os.path.join(
    "tests", "data", "ptminer_1_0", "test_ptminer_1_0_annotated_results.txt"
)

output_csv = os.path.join(
    "tests", "data", "ptminer_1_0", "test_ptminer_1_0_merged_results.csv"
)

expected_output_csv = os.path.join(
    "tests", "data", "ptminer_1_0", "test_ptminer_1_0_expected_results.csv"
)
...
def postflight_ptminer(test_dict_items, expected_dict_items):
    for i, test_item in enumerate(test_dict_items):
        ...
        expected_value = {1}
        """.format(
            test_value, expected_value, test_key
        )
