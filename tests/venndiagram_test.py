...
input1 = os.path.join("tests", "data", "venndiagram", "venndiagram_test_input1.csv")

input2 = os.path.join("tests", "data", "venndiagram", "venndiagram_test_input2.csv")

input3 = os.path.join("tests", "data", "venndiagram", "venndiagram_test_input3.csv")

expected_output = os.path.join(
    "tests", "data", "venndiagram", "venndiagram_test_expected_output.csv"
)
...
def venndiagram(input1, input2, input3, column_name, output_diagram, engine_version):
    ...
    uc = ursgal.UController(
        params={
            "visualization_label_positions": {"0": "set1", "1": "set2", "2": "set3"},
...
for engine_version in ["venndiagram_1_0_0", "venndiagram_1_1_0"]:
    output_path = venndiagram(
        input1, input2, input3, column_name, output_diagram, engine_version
    )
...
def venndiagram_output(test_dict, expected_dict):
    assert test_dict == expected_dict, print(test_dict, expected_dict)
