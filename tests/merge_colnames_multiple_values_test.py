...
TESTS = [
    {
        ...
        "output": {"XTandem": 34, "Spectrum ID": "5", "PEP": "3.5;2"},
    ...
    },
    {
        ...
        "output": {"XTandem": 1, "Spectrum ID": "5", "PEP": "3.5;2"},
    ...
    },
    {
        ...
        "output": {"XTandem": 29.5, "Spectrum ID": "5", "PEP": "3.5;2"},
    ...
    },
    {
        ...
        "output": {"XTandem": "1", "Spectrum ID": "5", "PEP": "3.5;2;2"},
    ...
    },
    {
        ...
        "output": {"XTandem": "34;1", "Spectrum ID": "5", "PEP": "3.5;2;2;2;2"},
        "type_merge": "most_frequent",
    },
]
...
def merge_rowdicts(test_dict):
    output = ursgal.ucore.merge_rowdicts(
        ...
        joinchar=";",
        psm_colnames_to_merge_multiple_values={"XTandem": test_dict["type_merge"]},
    )
