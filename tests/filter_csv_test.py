...
TESTS = [
    ...
    {
        "csv_filter_rules": [["Modifications", "regex", "Carbamidomethyl\:2"]],
        "number_of_expected_lines": 6,
    },
    {
        "csv_filter_rules": [["Spectrum Title", "regex", ".25\d*."]],
        "number_of_expected_lines": 8,
    },
    {
        "csv_filter_rules": [["Sequence", "regex", "C[T|D]"]],
        "number_of_expected_lines": 6,
    },
    {
        "csv_filter_rules": [
            [
                "Modifications",
                "contains_element_of_list",
                ["Oxidation", "Carbamidomethyl"],
            ]
        ],
        "number_of_expected_lines": 9,
    },
...
filter_csv_main = R.unodes["filter_csv_1_0_0"][
    "class"
].import_engine_as_python_function()

input_csv = os.path.join(
    "tests", "data", "test_BSA1_omssa_2_1_9_unified_filter_csv_test.csv"
)
