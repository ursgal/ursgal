...
def main(
    ...
    rt_summary_file = os.path.join(output_file)
    ...
    results.write_rt_info_file(
        output_file=rt_summary_file, rt_border_tolerance=float(rt_border_tolerance)
    )
    results.calc_amounts_from_rt_info_file(
        rt_info_file=rt_summary_file, rt_border_tolerance=float(rt_border_tolerance)
    )
