    ...
    if len(args) == 2:
        ...
        returnDict = {
            ...
            'A&B&C'     : {
                ...
                'y'      : kwargs['cy'] + 100  ,
                'results': None,
                'name'   : 'A_B_C_unique_intersection'
            },
            'A-(B|C)'   : {
                'value'  : 'A',
                'x'      : kwargs['cx'] - 190 ,
        ...
        returnDict = {
            ...
            '(A&C&D)-B' : {
                ...
                'y'      : kwargs['cy'] + 170  ,
                'results': None,
                'name'   : 'A_C_D_unique_intersection'
            },
            '(A&B&D)-C' : {
                'value'  : 'A.B.D',
                'x'      : kwargs['cx'] + 55  ,
                'y'      : kwargs['cy'] + 170  ,
                'results': None,
                'name'   : 'A_B_D_unique_intersection'
            },
            '(A&B&C)-D' : {
                'value'  : 'A.B.C',
                'x'      : kwargs['cx'] - 95  ,
            ...
            '(B&C&D)-A' : {
                ...
                'y'      : kwargs['cy'] + 30   ,
                'results': None,
                'name'   : 'B_C_D_unique_intersection'
            },
            'A-(B|C|D)' : {
                'value'  : 'A',
                'x'      : kwargs['cx'] - 200 ,
        ...
        returnDict = {
            'A-(B|C|D|E)'       : {'value' : 'A',         'x': kwargs['cx'] - 270  , 'y' : kwargs['cy'] - 30   , 'results': None , 'name': 'A_unique' },
            'D-(A|B|C|E)'       : {'value' : 'D',         'x': kwargs['cx'] + 130  , 'y' : kwargs['cy'] + 300  , 'results': None , 'name': 'D_unique' },
            'B-(A|C|D|E)'       : {'value' : 'B',         'x': kwargs['cx']        , 'y' : kwargs['cy'] - 200  , 'results': None , 'name': 'B_unique' },
            'C-(A|B|D|E)'       : {'value' : 'C',         'x': kwargs['cx'] + 240  , 'y' : kwargs['cy'] - 10   , 'results': None , 'name': 'C_unique' },
            'E-(B|C|D|A)'       : {'value' : 'E',         'x': kwargs['cx'] - 180  , 'y' : kwargs['cy'] + 300  , 'results': None , 'name': 'E_unique' },
            'A&B-(C|D|E)'       : {'value' : 'A.B',       'x': kwargs['cx'] - 110  , 'y' : kwargs['cy'] - 120  , 'results': None , 'name': 'A_B_unique_intersection' },
            'C&D-(A|B|E)'       : {'value' : 'C.D',       'x': kwargs['cx'] + 170  , 'y' : kwargs['cy'] + 170  , 'results': None , 'name': 'C_D_unique_intersection' },
            'B&C-(A|D|E)'       : {'value' : 'B.C',       'x': kwargs['cx'] + 135  , 'y' : kwargs['cy'] - 70   , 'results': None , 'name': 'B_C_unique_intersection' },
            'E&C-(A|D|B)'       : {'value' : 'C.E',       'x': kwargs['cx'] - 175  , 'y' : kwargs['cy'] + 190  , 'results': None , 'name': 'E_C_unique_intersection' },
            'B&E-(A|D|C)'       : {'value' : 'B.E',       'x': kwargs['cx'] + 40   , 'y' : kwargs['cy'] - 120  , 'results': None , 'name': 'B_E_unique_intersection' },
            'A&E-(B|D|C)'       : {'value' : 'A.E',       'x': kwargs['cx'] - 230  , 'y' : kwargs['cy'] + 90   , 'results': None , 'name': 'A_E_unique_intersection' },
            'E&D-(A|C|B)'       : {'value' : 'D.E',       'x': kwargs['cx'] - 50   , 'y' : kwargs['cy'] + 275  , 'results': None , 'name': 'E_D_unique_intersection' },
            'A&C-(B|D|E)'       : {'value' : 'A.C',       'x': kwargs['cx'] + 185  , 'y' : kwargs['cy'] + 80   , 'results': None , 'name': 'A_C_unique_intersection' },
            'B&D-(A|C|E)'       : {'value' : 'B.D',       'x': kwargs['cx'] + 50   , 'y' : kwargs['cy'] + 260  , 'results': None , 'name': 'B_D_unique_intersection' },
            'A&D-(B|C|E)'       : {'value' : 'A.D',       'x': kwargs['cx'] - 175  , 'y' : kwargs['cy'] - 60   , 'results': None , 'name': 'A_D_unique_intersection' },
            '(A&C&D)-(B|E)'     : {'value' : 'A.C.D',     'x': kwargs['cx'] + 175  , 'y' : kwargs['cy'] + 125  , 'results': None , 'name': 'A_C_D_unique_intersection' },
            '(A&B&D)-(C|E)'     : {'value' : 'A.B.D',     'x': kwargs['cx'] - 130  , 'y' : kwargs['cy'] - 90   , 'results': None , 'name': 'A_B_D_unique_intersection' },
            '(A&B&C)-(D|E)'     : {'value' : 'A.B.C',     'x': kwargs['cx'] + 150  , 'y' : kwargs['cy'] + 10   , 'results': None , 'name': 'A_B_C_unique_intersection' },
            '(B&C&D)-(A|E)'     : {'value' : 'B.C.D',     'x': kwargs['cx'] + 90   , 'y' : kwargs['cy'] + 205  , 'results': None , 'name': 'B_C_D_unique_intersection' },
            '(B&D&E)-(A|C)'     : {'value' : 'B.D.E',     'x': kwargs['cx'] - 15   , 'y' : kwargs['cy'] + 260  , 'results': None , 'name': 'B_D_E_unique_intersection' },
            '(E&B&C)-(A|D)'     : {'value' : 'B.C.E',     'x': kwargs['cx'] + 85   , 'y' : kwargs['cy'] - 95   , 'results': None , 'name': 'E_B_C_unique_intersection' },
            '(C&D&E)-(A|B)'     : {'value' : 'C.D.E',     'x': kwargs['cx'] - 105  , 'y' : kwargs['cy'] + 220  , 'results': None , 'name': 'C_D_E_unique_intersection' },
            '(A&B&E)-(D|C)'     : {'value' : 'A.B.E',     'x': kwargs['cx'] - 10   , 'y' : kwargs['cy'] - 105  , 'results': None , 'name': 'A_B_E_unique_intersection' },
            '(A&D&E)-(B|C)'     : {'value' : 'A.D.E',     'x': kwargs['cx'] - 180  , 'y' : kwargs['cy'] + 10   , 'results': None , 'name': 'A_D_E_unique_intersection' },
            '(A&E&C)-(D|B)'     : {'value' : 'A.C.E',     'x': kwargs['cx'] - 200  , 'y' : kwargs['cy'] + 130  , 'results': None , 'name': 'A_E_C_unique_intersection' },
            '(A&B&C&D)-E'       : {'value' : 'A.B.C.D',   'x': kwargs['cx'] + 120  , 'y' : kwargs['cy'] + 140  , 'results': None , 'name': 'A_B_C_D_unique_intersection' },
            '(A&B&C&E)-D'       : {'value' : 'A.B.C.E',   'x': kwargs['cx'] + 75   , 'y' : kwargs['cy'] - 60   , 'results': None , 'name': 'A_B_C_E_unique_intersection' },
            '(A&B&D&E)-C'       : {'value' : 'A.B.D.E',   'x': kwargs['cx'] - 110  , 'y' : kwargs['cy'] - 55   , 'results': None , 'name': 'A_B_D_E_unique_intersection' },
            '(A&C&D&E)-B'       : {'value' : 'A.C.D.E',   'x': kwargs['cx'] - 170  , 'y' : kwargs['cy'] + 90   , 'results': None , 'name': 'A_C_D_E_unique_intersection' },
            '(B&C&D&E)-A'       : {'value' : 'B.C.D.E',   'x': kwargs['cx'] - 20   , 'y' : kwargs['cy'] + 220  , 'results': None , 'name': 'B_C_D_E_unique_intersection' },
