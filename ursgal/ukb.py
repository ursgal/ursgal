...
FILE_EXTENSIONS = {
    ".dat": {
        ...
        "same_extension": [],
        "description": "Mascot specific identification output format."
    ...
    ".csv": {
        ...
        "same_extension": [],
        "description": "The comma-separated values (CSV) file format is a "
    ...
    ".cfg": {
        ...
        "same_extension": [],
        "description": "pGlyco specific parameter file format.",
    },
    ".den": {
        "short_name": "DEN",
        "long_name": "DEN (XMVB Density Data)",
        "same_extension": [],
        "description": "DEN file is a XMVB Density Data. Xiamen Valence Bond "
    ...
    ".dta": {
        ...
        "same_extension": [],
        "description": "DTA file is a Stata Data File. Stata is a "
    ...
    ".dta.txt": {
        ...
        "same_extension": [],
        "description": "Text format of DTA format.",
    },
    ".fasta": {
        "short_name": "FASTA",
        "long_name": "FASTA (Sequence Alignment)",
        "same_extension": [".fa", ".mpfa", ".fna", ".fsa", ".fas"],
        "description": "FASTA file is a FASTA Sequence. In bioinformatics, FASTA "
    ...
    ".fm.1": {
        ...
        "long_name": "FM index",
        "same_extension": [],
        "description": "FM index file format",
    },
    ".gaml": {
        "short_name": "GAML",
        "long_name": "GAML (GAML spectra)",
        "same_extension": [],
        "description": "GAML spectra",
    },
    ".idx.gz": {
        "short_name": "igzip",
        "long_name": "igzipped mzML (MS data)",
        "same_extension": [],
        "description": "Compressed mzML, indexed gzip according to pymzML2.0",
    },
    ".kojak.txt": {
        "short_name": "Kojak",
        "long_name": "Kojak (Kojak result)",
        "same_extension": [],
        "description": "Kojak result",
    },
    ".mgf": {
        "short_name": "MGF",
        "long_name": "MGF (Mascot Generic Format)",
        "same_extension": [],
        "description": "The Mascot generic format for a data file submitted to Mascot",
    },
    ".ms2": {
        "short_name": "MS2",
        "long_name": "MS2 (MS data)",
        "same_extension": [],
        "description": "Mass spectrometry data format",
    },
    ".mzData": {
        "short_name": "mzData",
        "long_name": "mzData (MS data)",
        "same_extension": [],
        "description": "This format was deprecated, and was replaced by mzML",
    },
    ".mzid": {
        "short_name": "mzid",
    ...
    ".mzML.gz": {
        ...
        "long_name": "mzML (MS data)",
        "same_extension": [],
        "description": "Compressed mzML",
    },
    ".mzXML": {
        "short_name": "mzXML",
        "long_name": "mzXML (MS data)",
        "same_extension": [],
        "description": "This format was replaced by mzML",
    },
    ".pep.xml": {
        "short_name": "pep.xml",
    ...
    ".pepXML": {
        ...
        "long_name": "pepXML",
        "same_extension": [],
        "description": "open data format for different MS/MS search engines",
    },
    ".perc.inter.txt": {
    ...
    ".pkl": {
        ...
        "same_extension": [],
        "description": "PKL file is a file created by the Python pickle module",
    },
    ".raw": {
        "short_name": "RAW",
        "long_name": "RAW (ThermoFisher RAW format)",
        "same_extension": [],
        "description": "ThermoFisher RAW format",
    },
    ".ssl": {
        "short_name": "SSL",
        "long_name": "SSL (Spectrum Sequence List)",
        "same_extension": [],
        "description": "Generic tab-delimited text file format supported by BiblioSpec",
    },
    ".svg": {
        "short_name": "SVG",
        "long_name": "SVG (Scalable Vector Graphic)",
        "same_extension": [],
        "description": "SVG file is a Scalable Vector Graphic. SVG is a language "
    ...
    ".tsv": {
        ...
        "same_extension": [],
        "description": "TSV is a Tab-Separated Values document. It is very "
    ...
    ".txt": {
        ...
        "same_extension": [".text"],
        "description": "TXT file is a plain text. Plain text is textual "
    ...
    ".xml": {
        ...
        "same_extension": [],
        "description": "XML file is an Extensible Markup Language document. XML "
