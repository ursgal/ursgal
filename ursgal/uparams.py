ursgal_params = {
    ...
    'allow_multiple_variable_mods_on_residue' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'allow_multiple_variable_mods_on_residue',
        },
        'utag' : [
            'modifications'
        ],
    ...
    'clip_nterm_m' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'clip_nTerm_M',
        },
        'utag' : [
        ],
        'uvalue_option' : {
    ...
    'cpus' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1'   : 'num_threads',
    ...
    'database' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1'           : 'database_name',
            'pipi_style_1'                : 'db',
    ...
    'decoy_tag' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1'             : 'decoy_prefix',
        },
        'utag' : [
            'database',
        ],
    ...
    'enzyme' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1'             : 'enzyme',
    ...
    'frag_clear_mz_range' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'clear_mz_range',
    ...
    'frag_mass_tolerance' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'fragment_mass_tolerance',
    ...
    'frag_mass_tolerance_unit' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'fragment_mass_units',
    ...
    'frag_max_charge' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1': 'max_fragment_charge',
        },
        'utag' : [
            'fragment',
            'spectrum',
    ...
    'header_translations' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1'        : 'header_translations',
    ...
    'intensity_cutoff' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1': 'minimum_ratio'
        },
        'utag' : [
            'spectrum',
        ],
    ...
    'max_accounted_observed_peaks' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'use_topN_peaks',
        },
        'utag' : [
            'spectrum',
            'fragment',
    ...
    'max_missed_cleavages' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1'       : 'allowed_missed_cleavage',
    ...
    'max_num_per_mod' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'max_variable_mods_per_mod',
    ...
    'max_pep_length' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'digest_max_length',
    ...
    'max_pep_var' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'max_variable_mods_combinations',
        },
        'utag' : [
            'peptide',
            'modifications'
    ...
    'min_pep_length' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'digest_min_length',
    ...
    'min_required_matched_peaks' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'min_matched_fragments',
        },
        'utag' : [
            'fragment',
            'spectrum',
    ...
    'min_required_observed_peaks' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1': 'minimum_peaks',
        },
        'utag' : [
            'fragment',
            'spectrum',
    ...
    'modifications' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1'       : 'modifications',
    ...
    'msfragger_output_max_expect' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'output_max_expect',
        },
        'utag' : [
            'output',
            'scoring'
    ...
    'msfragger_track_zero_topN' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'track_zero_topN',
        },
        'utag' : [
            'output',
            'scoring'
    ...
    'msfragger_zero_bin_accept_expect' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'zero_bin_accept_expect',
        },
        'utag' : [
            'scoring'
        ],
    ...
    'msfragger_zero_bin_mult_expect' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'zero_bin_mult_expect',
        },
        'utag' : [
            'scoring'
        ],
    ...
    'msfragger_add_topN_complementary' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'add_topN_complementary',
        },
        'utag' : [
            'scoring',
            'spectrum'
    ...
    'msfragger_min_fragments_modelling' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'min_fragments_modelling',
        },
        'utag' : [
            'spectrum',
            'scoring'
    ...
    'num_match_spec' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'output_report_topN',
    ...
    'precursor_isotope_range' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'isotope_error',
        },
        'utag' : [
            'precursor',
        ],
    ...
    'precursor_mass_tolerance_minus' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1'  : 'precursor_mass_tolerance',
    ...
    'precursor_mass_tolerance_unit' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'precursor_mass_units',
    ...
    'precursor_max_charge' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1': 'precursor_max_charge',
    ...
    'precursor_max_mass' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'precursor_max_mass',
    ...
    'precursor_min_charge' : {
        ...
        'ukey_translation': {
            ...
            'msfrag_20190628_style_1': 'precursor_min_charge',
    ...
    'precursor_min_mass' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'precursor_min_mass',
    ...
    'precursor_true_tolerance' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'precursor_true_tolerance',
        },
        'utag' : [
            'precursor',
            'accuracy'
    ...
    'precursor_true_units' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'precursor_true_units',
        },
        'utag' : [
            'precursor',
            'accuracy'
    ...
    'semi_enzyme' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1' : 'num_enzyme_termini',
        },
        'utag' : [
            'protein',
            'cleavage'
    ...
    'use_spectrum_charge' : {
        ...
        'ukey_translation' : {
            ...
            'msfrag_20190628_style_1': 'override_charge',
        },
        'utag' : [
            'precursor',
            'spectrum'
    ...
    'calibrate_mass' : {
        ...
        'triggers_rerun' : True,
        'ukey_translation' : {
            'msfrag_20190628_style_1' : 'calibrate_mass',
        },
        'utag' : [
            'scoring',
            'spectrum'
    ...
    'localize_delta_mass' : {
        ...
        'triggers_rerun' : True,
        'ukey_translation' : {
            'msfrag_20190628_style_1' : 'localize_delta_mass',
        },
        'utag' : [
            'scoring',
            'spectrum'
