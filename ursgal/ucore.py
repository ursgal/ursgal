...
def print_current_params(params, old_params=None):
    ...
    if old_params is not None and skipped_unchanged_params > 0:
        print(
            "\t{0} parameters have not been changed since last printout, thus skipped ".format(
...
def pyteomics_cleave(
    sequence, rule, missed_cleavages=0, min_length=None, max_length=100
):
