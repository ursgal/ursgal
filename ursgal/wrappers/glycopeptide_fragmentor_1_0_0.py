...
class glycopeptide_fragmentor_1_0_0(ursgal.UNode):
    ...
    def _execute(self):
        ...
        glycopep_params = {}
        glycopep_params["frag_mass_tolerance"] = self.params["translations"][
            "frag_mass_tolerance"
        ]
        if self.params["translations"]["frag_mass_tolerance_unit"] == "da":
            glycopep_params["frag_mass_tolerance"] = ursgal.ucore.convert_dalton_to_ppm(
        ...
        glycopep_params["mzml_file_list"] = self.params["translations"][
            "mzml_input_files"
        ]
        glycopep_params["internal_precision"] = self.params["translations"][
            "internal_precision"
        ]
        glycopep_params["decoy_glycan"] = self.params["translations"][
