...
class glycopeptide_fragmentor_1_0_0(ursgal.UNode):
    ...
    def _execute(self):
        ...
        glycopep_params = {}
        glycopep_params['frag_mass_tolerance'] = self.params[
        ...
        glycopep_params['mzml_file_list'] = self.params[
            'translations']['mzml_input_files']
        glycopep_params['internal_precision'] = self.params[
            'translations']['internal_precision']
        glycopep_params['decoy_glycan'] = self.params[
            'translations']['sugarpy_decoy_glycan']
        glycopep_params['min_Y_ions'] = self.params[
            'translations']['min_y_ions']
        glycopep_params['min_oxonium_ions'] = self.params[
            'translations']['min_oxonium_ions']
