...
class msgfplus2csv_v2016_09_16(ursgal.UNode):
    ...
    def preflight(self):
        ...
        self.params["command_list"] = [
            ...
            "-showQValue",
            "{0}".format(self.params["translations"]["output_q_values"]),
            "-showDecoy",
            "1",
            "-unroll",
            "0",
        ...
        self.created_tmp_files.append(
            self.params["translations"]["output_file_incl_path"].strip(".csv") + ".tsv"
        )
