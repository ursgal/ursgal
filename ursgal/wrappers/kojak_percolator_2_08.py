...
class kojak_percolator_2_08(ursgal.UNode):
    ...
    META_INFO = {
        ...
        "citation": "K・・ｽ､ll L, Canterbury JD, Weston J, Noble WS, MacCoss MJ. (2007) "
    ...
    def postflight(self):
        ...
        for pos, line_dict in enumerate(percolator_output_dict_reader):
            ...
            for key, value in line_dict.items():
                if key in [None, "proteinIds"]:
                    ...
                    new_key = self.UNODE_UPARAMS["header_translations"][
                        "uvalue_style_translation"
                    ][key]
        ...
        self.created_tmp_files += [self.params["translations"]["output_file_incl_path"]]
