...
class moda_v1_61(ursgal.UNode):
    ...
    META_INFO = {
        ...
        "citation": "Na S, Bandeira N, Paek E. (2012) Fast multi-blind modification "
    ...
    def preflight(self):
        ...
        translations["Spectra"]["mgf_input_file"] = self.params["translations"][
            "mgf_input_file"
        ]

        params_input_file = open(
            self.params["translations"]["params_input_file"], "w", encoding="UTF-8"
        )
        ...
        if translations["PPMTolerance"]["precursor_mass_tolerance_unit"] == "da":
            translations["PeptTolerance"] = (
                ...
                + translations["PPMTolerance"]["precursor_mass_tolerance_plus"]
            ) / 2
        ...
        if translations["FragTolerance"]["frag_mass_tolerance_unit"] == "ppm":
            translations["FragTolerance"] = ursgal.ucore.convert_ppm_to_dalton(
            ...
            translations["FragTolerance"] = translations["FragTolerance"][
                "frag_mass_tolerance"
            ]
    ...
    def postflight(self):
        ...
        org_moda_out = self.params["translations"]["output_file_incl_path"].replace(
            ".csv", ".tsv"
        )
        out_line_dicts = []
            ...
            for row in out_reader:
                if len(row) <= 1:
                    ...
                    peptide_unimod = ursgal.ucore.reformat_peptide(
                        regex_pattern, None, org_sequence
                    )
