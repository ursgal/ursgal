...
class _test_node(ursgal.UNode):
    ...
    META_INFO = {
        ...
        "citation": "TEST/DEBUG: Internal Ursgal UNode for debugging nd testing.",
    }
    ...
    def preflight(self):
        ...
        # ]
        time.sleep(2)
        self.print_info("Test UNode: preflight() was executed, slept for 2 seconds!")
        self.print_info("Scheduled command: {command_list}".format(**self.params))
