...
class add_estimated_fdr_1_0_0(ursgal.UNode):
    ...
    META_INFO = {
        ...
        "engine_type": {"validation_engine": True},
        ...
        "citation": "An implementation of the target/decoy FDR estimation method "
    ...
    def _execute(self):
        ...
        # use that:
        if (
            self.params["validation_score_field"] is not None
            and self.params["bigger_scores_better"] is not None
        ):
