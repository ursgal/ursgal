...
'''The function simple_example_search was stolen from one of the example scripts of ursgal and was only used to test the function of
the engines. 
...
def Cre_PCGSD ():
    database_path = 'C:/Cre_PCGSD/Creinhardtii_281_v5_5_CP_MT_with_contaminants_target_decoy.fasta'
    uc = ursgal.UController(
        profile = 'QExactive+',
        params = {
    ...
    uc.scan_rt_lookup_path = 'C:/Cre_PCGSD/_ursgal_lookup.pkl'
