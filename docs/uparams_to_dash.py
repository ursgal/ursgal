...
colors = {"background_header": "#297FB8", "text_header": "#FCFFFF"}
...
for which the corresponding parameters should be displayed
        ...
        html.Div(
            [
                ...
                dcc.Dropdown(id="params", value="all_uparams", multi=True),
            ],
            style={
                "width": "32%",
                "marginLeft": 10,
        ...
        html.Div(
            [
                ...
                dcc.Dropdown(id="engine", value="all_engines", multi=True),
            ],
            style={
                "width": "32%",
                "marginLeft": 10,
        ...
        html.Div(
            [
                ...
                dcc.Dropdown(id="tag", value="all_tags", multi=True),
            ],
            style={
                "width": "32%",
                "display": "inline-block",
            ...
            [
                dcc.Checklist(
                    ...
                    options=[
                        ...
                        {"label": "Show Ursgal tags", "value": "show_utags"},
                        {
...
@app.callback(
    ...
    [
        ...
        dash.dependencies.Input("text_options", "value"),
    ],
)
def update_text(
    selected_engines, selected_uparams, selected_tags, selected_text_options
):
    if selected_uparams == "all_uparams":
...
""".format(
            ...
            for style, translation in sorted(udict["ukey_translation"].items()):
                text.append("* {0}: {1}".format(style, translation))
