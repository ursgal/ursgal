...
{'batch_size': {'available_in_unode': ['xtandem'],
                ...
                'ukey_translation': {'xtandem_style_1': 'spectrum, sequence '
                                                        'batch size'},
                'uvalue_translation': '',
                'uvalue_type': ''},
 'cleavage_cterm_mass_change': {'available_in_unode': ['xtandem'],
                                ...
                                'ukey_translation': {'xtandem_style_1': 'protein, '
                                                                        'cleavage '
                                                                        'C-terminal '
                                                                        'mass '
                                                                        'change'},
 ...
 'compensate_small_fasta': {'available_in_unode': ['xtandem'],
                            ...
                            'description': 'compensate for very small database '
                                           'files.',
                            'ukey_translation': {'xtandem_style_1': 'scoring, '
                                                                    'cyclic '
                                                                    'permutation'},
                            'uvalue_translation': '',
                            'uvalue_type': ''},
 ...
 'cpus': {'available_in_unode': ['xtandem', 'omssa', 'msgfplus', 'myrimatch'],
          ...
          'ukey_translation': {'msgfplus_style_1': '-thread',
 ...
 'database': {'available_in_unode': ['omssa', 'msgfplus', 'myrimatch'],
              ...
              'ukey_translation': {'msgfplus_style_1': '-d',
 ...
 'enzyme': {'available_in_unode': ['xtandem',
            ...
            'ukey_translation': {'msamanda_style_1': 'enzyme specificity',
                                 'msgfplus_style_1': '-e',
 ...
 'forbidden_cterm_mods': {'available_in_unode': ['xtandem'],
                          ...
                          'ukey_translation': {'xtandem_style_1': 'residue, '
                                                                  'potential '
                                                                  'modification '
                                                                  'mass'},
                          'uvalue_translation': '',
 ...
 'frag_mass_tolerance': {'available_in_unode': ['xtandem', 'omssa'],
                         ...
                         'description': 'Fragment mass type: monoisotopic or '
                                        'average',
                         'ukey_translation': {'omssa_style_1': '-to',
                                              'xtandem_style_1': 'spectrum, '
                                                                 'fragment '
                                                                 'monoisotopic '
                                                                 'mass error'},
                         'uvalue_translation': '',
 ...
 'frag_mass_tolerance_unit': {'available_in_unode': ['xtandem'],
                              ...
                              'ukey_translation': {'xtandem_style_1': 'spectrum, '
                                                                      'fragment '
                                                                      'monoisotopic '
                                                                      'mass '
                                                                      'error '
 ...
 'frag_mass_type': {'available_in_unode': ['xtandem', 'omssa'],
                    ...
                    'description': 'Fragment mass type: monoisotopic or '
                                   'average',
                    'ukey_translation': {'omssa_style_1': '-tom',
                                         'xtandem_style_1': 'spectrum, '
                                                            'fragment mass '
                                                            'type'},
                    'uvalue_translation': '',
 ...
 'frag_method': {'available_in_unode': ['msgfplus', 'myrimatch'],
                 ...
                 'ukey_translation': {'msgfplus_style_1': '-m',
 ...
 'frag_min_mz': {'available_in_unode': ['xtandem'],
                 ...
                 'ukey_translation': {'xtandem_style_1': 'spectrum, minimum '
                                                         'fragment mz'},
                 'uvalue_translation': '',
                 'uvalue_type': ''},
 ...
 'include_reverse (not used)': {'available_in_unode': ['xtandem',
                                ...
                                'ukey_translation': {'msamanda_style_1': 'generate_decoy',
                                                     'msgfplus_style_1': '-tda',
                                                     'xtandem_style_1': 'scoring, '
                                                                        'include '
                                                                        'reverse'},
                                'uvalue_translation': '',
                                'uvalue_type': ''},
 'input_file': {'available_in_unode': ['xtandem', 'msgfplus'],
                ...
                'ukey_translation': {'msgfplus_style_1': '-s',
 ...
 'input_file_type': {'available_in_unode': ['xtandem'],
                     ...
                     'ukey_translation': {'xtandem_style_1': 'spectrum, path '
                                                             'type'},
                     'uvalue_translation': '',
                     'uvalue_type': ''},
 ...
 'label': {'available_in_unode': ['xtandem', 'omssa'],
           ...
           'description': "'15N' if the corresponding amino acid labeling was "
                          'applied',
           'ukey_translation': {'omssa_style_1': '-tem / -tom',
                                'xtandem_style_1': 'protein, modified residue '
                                                   'mass file'},
           'uvalue_translation': '',
           'uvalue_type': ''},
 ...
 'max_num_mods': {'available_in_unode': ['msgfplus'],
                  ...
                  'ukey_translation': {'msgfplus_style_1': 'NumMods'},
                  'uvalue_translation': '',
                  'uvalue_type': ''},
 ...
 'max_pep_length': {'available_in_unode': ['omssa', 'msgfplus', 'myrimatch'],
                    ...
                    'ukey_translation': {'msgfplus_style_1': '-maxLength',
 ...
 'maximal_accounted_observed_peaks': {'available_in_unode': ['xtandem',
                                      ...
                                      'ukey_translation': {'myrimatch_style_1': '-MaxPeakCount',
                                                           'xtandem_style_1': 'spectrum, '
                                                                              'total '
                                                                              'peaks'},
                                      'uvalue_translation': '',
 ...
 'maximum_missed_cleavages': {'available_in_unode': ['xtandem',
                              ...
                              'ukey_translation': {'msamanda_style_1': 'missed_cleavages',
 ...
 'min_pep_length': {'available_in_unode': ['omssa', 'msgfplus', 'myrimatch'],
                    ...
                    'ukey_translation': {'msgfplus_style_1': '-minLength',
 ...
 'mininimal_required_matched_peaks': {'available_in_unode': ['xtandem',
                                      ...
                                      'description': 'Mimimum number of '
                                                     ...
                                                     'for a peptide to be '
                                                     'scored',
                                      'ukey_translation': {'omssa_style_1': '-hm',
                                                           'xtandem_style_1': 'scoring, '
                                                                              'minimum '
                                                                              'ion '
                                                                              'count'},
 ...
 'mininimal_required_observed_peaks': {'available_in_unode': ['xtandem',
                                       ...
                                       'description': 'Mimimum number of peaks '
                                                      ...
                                                      'considered.',
                                       'ukey_translation': {'omssa_style_1': '-hs',
                                                            'xtandem_style_1': 'spectrum, '
                                                                               'minimum '
                                                                               'peaks'},
                                       'uvalue_translation': '',
 ...
 'modifications': {'available_in_unode': ['xtandem',
                   ...
                   'ukey_translation': {'msamanda_style_1': 'modification '
                                                            'protein=true '
                                                            'cterm=true',
                                        'msgfplus_style_1': '-mod',
                                        'myrimatch_style_1': '-StaticMods<str>',
                                        'omssa_style_1': '-mv',
                                        'xtandem_style_1': 'protein, '
                                                           'C-terminal residue '
                                                           'modification mass'},
                   'uvalue_translation': '',
                   'uvalue_type': ''},
 ...
 'num_match_spec': {'available_in_unode': ['omssa',
                    ...
                    'description': 'This parameter sets the maximum number of '
                                   ...
                                   'each spectrum',
                    'ukey_translation': {'msamanda_style_1': 'Specify the '
                                                             'number of '
                                                             'matches to '
                                                             'report for each '
                                                             'spectrum',
                                         'msgfplus_style_1': 'number of '
                                                             'matches per '
                                                             'spectrum to be '
                                                             'reported',
                                         'myrimatch_style_1': 'This parameter '
                                                              'sets the '
                                                              'maximum rank of '
                                                              'peptide-spectrum-matches '
                                                              'to report for '
                                                              'each spectrum',
                                         'omssa_style_1': 'maximum number of '
                                                          'hits retained per '
                                                          'precursor charge '
                                                          'state per spectrum'},
                    'uvalue_translation': '',
 ...
 'precursor_isotope_range': {'available_in_unode': ['xtandem', 'msgfplus'],
                             ...
                             'ukey_translation': {'msgfplus_style_1': '-ti',
                                                  'xtandem_style_1': 'spectrum, '
                                                                     'parent '
                                                                     'monoisotopic '
                                                                     'mass '
 ...
 'precursor_mass_tolerance_minus': {'available_in_unode': ['xtandem',
                                    ...
                                    'description': 'Precursor mass tolerance: '
                                                   ...
                                                   'parent ion M+H',
                                    'ukey_translation': {'msamanda_style_1': 'ms1_tol',
                                                         'msgfplus_style_1': '-t',
 ...
 'precursor_mass_type': {'available_in_unode': ['omssa',
                         ...
                         'description': 'Precursor mass type: monoisotopic or '
                                        'average',
                         'ukey_translation': {'msamanda_style_1': 'monoisotopic',
 ...
 'precursor_max_charge': {'available_in_unode': ['omssa',
                          ...
                          'ukey_translation': {'msamanda_style_1': 'considered_charges',
 ...
 'precursor_min_mass': {'available_in_unode': ['xtandem', 'myrimatch'],
                        ...
                        'ukey_translation': {'myrimatch_style_1': '-MinPeptideMass '
                                                                  '<real>',
                                             'xtandem_style_1': 'spectrum, '
                                                                'minimum '
                                                                'parent m+h '
 ...
 'score_-h2o_ions': {'available_in_unode': ['msamanda'],
                     ...
                     'ukey_translation': {'msamanda_style_1': 'series'},
                     'uvalue_translation': '',
                     'uvalue_type': ''},
 ...
 'search_for_saps': {'available_in_unode': ['xtandem'],
                     ...
                     'description': 'search for potential single amino acid '
                                    'polymorphisms',
                     'ukey_translation': {'xtandem_style_1': 'protein, saps'},
                     'uvalue_translation': '',
                     'uvalue_type': ''},
 'semi_enzyme': {'available_in_unode': ['xtandem',
                 ...
                 'ukey_translation': {'msamanda_style_1': 'enzyme specificity',
                                      ...
                                      'omssa_style_1': '-e',
                                      'xtandem_style_1': 'protein, cleavage '
                                                         'semi'},
                 'uvalue_translation': '',
                 'uvalue_type': ''},
 ...
 'stp_bias': {'available_in_unode': ['xtandem'],
              ...
              'description': 'Interpretation of peptide phosphorylation '
                             'models.',
              'ukey_translation': {'xtandem_style_1': 'protein, stP bias'},
              'uvalue_translation': '',
              'uvalue_type': ''},
 'ukey1': {'available_in_unode': ['xtandem', 'msamanda'],
           'default_value': '',
           'description': '',
           'ukey_translation': {'msamanda_style_1': 'modification protein=true '
                                                    'nterm=true',
                                'xtandem_style_1': 'protein, N-terminal '
 ...
 'ukey2': {'available_in_unode': ['xtandem'],
           'default_value': '',
           'description': '',
           'ukey_translation': {'xtandem_style_1': 'protein, quick acetyl'},
           'uvalue_translation': '',
           'uvalue_type': ''},
 'ukey3': {'available_in_unode': ['xtandem'],
           'default_value': '',
           'description': '',
           'ukey_translation': {'xtandem_style_1': 'protein, quick pyrolidone'},
           'uvalue_translation': '',
           'uvalue_type': ''},
 'ukey4': {'available_in_unode': ['xtandem', 'msamanda'],
           'default_value': '',
           'description': '',
           'ukey_translation': {'msamanda_style_1': 'modification fix=true',
                                'xtandem_style_1': 'residue, modification '
                                                   'mass'},
           'uvalue_translation': '',
           'uvalue_type': ''},
 'ukey5': {'available_in_unode': ['xtandem', 'msamanda'],
           'default_value': '',
           'description': '',
           'ukey_translation': {'msamanda_style_1': 'modification fix=false',
                                'xtandem_style_1': 'residue, potential '
                                                   'modification mass'},
           'uvalue_translation': '',
           'uvalue_type': ''},
 'ukey6': {'available_in_unode': ['xtandem'],
           'default_value': '',
           'description': '',
           'ukey_translation': {'xtandem_style_1': 'residue, potential '
                                                   'modification motif'},
           'uvalue_translation': '',
           'uvalue_type': ''},
